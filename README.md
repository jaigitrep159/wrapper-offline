# NOTE
[Dont use this to install wrapper offline. If you want to use wrapper offline. use the Installer](https://github.com/Wrapper-Offline/Wrapper-Offline-Installer)
