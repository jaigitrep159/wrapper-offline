# NOTE
[Dont use this repository to install Wrapper: Offline. If you want to use Wrapper: Offline, use the Installer](https://github.com/Wrapper-Offline/Wrapper-Offline-Installer)
